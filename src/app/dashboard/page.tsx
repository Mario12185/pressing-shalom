      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-30 shadow-sm">
        <div className="container mx-auto px-4 py-4 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/login" className="px-4 py-2 bg-[#722F37] text-white rounded-lg hover:bg-[#5a252c] transition text-sm font-medium">
              Déconnexion
            </Link>
          </div>
        </div>
      ...
      <div className="container mx-auto px-4 py-8 space-y-8">
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <a 
            ...
            download
            className="px-6 py-3 bg-white border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition font-medium shadow-sm flex items-center gap-2 cursor-pointer"
          >
            📥 Exporter CSV
          </a>
          ...
          <Link 
            href="/track" 
            target="_blank"
            className="px-6 py-3 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition font-medium shadow-sm flex items-center gap-2"
          >
